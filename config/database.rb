...
database_name = case Padrino.env
  when :development then 'fancyshpv2_development'
  when :production  then 'fancyshpv2_production'
  when :test        then 'fancyshpv2_test'
end
...
#     sessions:
#       default:
#         database: fancyshpv2_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: fancyshpv2_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: fancyshpv2_test
#         hosts:
#           - localhost:27017
#
#
